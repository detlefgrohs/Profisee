...
class api_matching_unit_tests(unittest.TestCase):
    ...
    def test_process_matching_actions(self):
        response = self.api.ProcessMatchingActions("MatchingTest", ProcessActions.MatchingOnly)
